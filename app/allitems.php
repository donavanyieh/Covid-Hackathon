...
@media (max-width: 767px) {
    ...
    $(async () => {
            ...
            if(Object.keys(data.items).length==0){
                $("#itemtable").append("<tr><th>No items posted. Be the first! :)</th></tr>");
            }
            else{
                $("#itemtable").append("<thead><tr><th>Item Name</th><th>Item Description</th><th>From</th><th>Unit Number</th></tr></thead><tbody>");
                for(var i = 0; i<count; i++){
                    ...
                    // $("#featured")
                    $("#itemtable").append("<tr>"+"<td>"+data.items[i]["itemname"]+"</td>"+"<td>"+data.items[i]["itemdescription"]+"</td>"+"<td>"+data.items[i]["username"]+"</td>"+"<td>"+data.items[i]["unit"]+"</td>"+"</tr>");
